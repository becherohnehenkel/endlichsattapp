...
// Seit PROJ-52 sitzt der Kcal-Rechner (und damit der "Speichern für eingeloggte
// Nutzer"-Block unten) hinter dem Einwilligungs-Gate für Gesundheitsdaten. Selbst
// geseedet statt von der Lauf-Reihenfolge anderer Spec-Files (z.B. PROJ-52 selbst, das
// die Einwilligung des gleichen QA-Kontos zwischenzeitlich widerruft) abhängig zu sein.
