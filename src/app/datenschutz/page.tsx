    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-prose mx-auto px-4 py-8 space-y-8 text-sm text-foreground">
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Gewicht, Größe, Alter, Geschlecht, Kalorienziel sowie deine Angaben im Wochen-Check-In (u. a. Schlaf, Energielevel) behandeln wir als besondere Kategorie personenbezogener Daten im Sinne von Art. 9 DSGVO. Wir verarbeiten diese Daten ausschließlich auf Grundlage deiner ausdrücklichen, gesonderten Einwilligung (Art. 9 Abs. 2 lit. a DSGVO), die du separat von dieser Datenschutzerklärung abgibst — entweder bei der Registrierung oder beim ersten Aufruf des Kalorien-Rechners bzw. Wochen-Check-Ins. Ohne diese Einwilligung sind die betroffenen Funktionen nicht nutzbar. Eine erteilte Einwilligung kannst du jederzeit mit Wirkung für die Zukunft in deiner Konto-Ansicht widerrufen (Art. 7 Abs. 3 DSGVO) — dabei werden deine Kalorien-Rechner-Werte sowie alle deine Wochen-Check-In-Einträge automatisch und unwiderruflich gelöscht, da uns ab dem Widerruf keine Rechtsgrundlage mehr für ihre weitere Speicherung zur Verfügung steht.
          </p>
        </section>
