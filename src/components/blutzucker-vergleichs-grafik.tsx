...
function Kurve({ titel, caption, pfad, farbe }: KurveProps) {
  return (
    <div className="space-y-2">
      ...
      >
        <line x1="0" y1="70" x2="300" y2="70" stroke="currentColor" className="text-border" strokeWidth="1" strokeDasharray="4 4" />
        <path d={pfad} fill="none" stroke={farbe} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
