...
| PROJ-6 | Mahlzeit-Historie (Refinement: Sortierung & Pagination "Deployed"; Test-Fix: Lade-Skelett-Flake behoben, PR #5) | P1 | Deployed | PROJ-1, PROJ-2, PROJ-4, PROJ-5 | [Spec](PROJ-6-mahlzeit-historie.md) |
...
| PROJ-20 | Datenschutzerklärung & Impressum (Refinement: Rechtstext-Aktualisierung & globaler Footer "Deployed") | P1 | Deployed | PROJ-2, PROJ-19 | [Spec](PROJ-20-datenschutz-impressum.md) |
...
| PROJ-24 | Zutaten-Reihenfolge & Gruppierung im Rezept-Editor (+ Markdown-Formatierung Zubereitung) (Refinement: Punktlinie Zutat → Menge "Deployed") | P2 | Deployed | PROJ-8 | [Spec](PROJ-24-rezept-zutaten-gruppierung.md) |
...
| PROJ-37 | So geht abnehmen (inkl. Kcal-Rechner) (Refinement: Stateless Gast-Persistenz "Approved") | P1 | Deployed | PROJ-36 | [Spec](PROJ-37-so-geht-abnehmen.md) |
...
| PROJ-39 | Heißhunger (Refinement: Icon-Feinschliff "Deployed") | P2 | Deployed | PROJ-36, PROJ-38 | [Spec](PROJ-39-heisshunger.md) |
| PROJ-40 | Kalorien (Refinement: Makronährstoffe visuell aufbereitet "Deployed") | P2 | Deployed | PROJ-36, PROJ-37 | [Spec](PROJ-40-kalorien.md) |
...
| PROJ-44 | Trainingspläne (Detailseiten + Gewicht-Logging) (Refinement: Numerische Felder beim Fitnessstudio-Plan "Deployed") | P1 | Deployed | PROJ-43, PROJ-2, PROJ-19, PROJ-42 | [Spec](PROJ-44-trainingsplaene.md) |
| PROJ-45 | Wochen-Check-In (Refinement: Slider-Feinschliff "Deployed") | P1 | Deployed | PROJ-2, PROJ-19, PROJ-35, PROJ-17, PROJ-42 | [Spec](PROJ-45-wochen-check-in.md) |
...
| PROJ-52 | Explizite Einwilligung für gesundheitsnahe Daten (Art. 9 DSGVO) | P1 | Approved | PROJ-2, PROJ-19, PROJ-37, PROJ-45, PROJ-14, PROJ-20, PROJ-51 | [Spec](PROJ-52-einwilligung-gesundheitsdaten.md) |
