...
- **Refinement-Deploy 2026-09-01** (Vercel auto-deploy via Push zu `main`, commits `3e0fb64`..`2e7aae4`, Tag `v2.8.0-ernaehrung-guides`): Teil eines gebündelten Deploys über PROJ-34/37/38/39/40/41 — Überschrift "Emotionales Abnehmen" + gekürzter Intro-Text (dieses Deploy war der Auslöser, das Auto-Open-Muster auf die übrigen Guides zu übertragen). Nutzer hat auf Produktion visuell bestätigt ("Alles auf Grün").
